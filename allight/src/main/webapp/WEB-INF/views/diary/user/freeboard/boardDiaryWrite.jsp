			...
			<div class="boardContent">
				...
				<table>
					<tr>
						...
						<td class="board-title" colspan="3"><input type="text"	name="ftitle" size="60%" required="required" value="${FDTO.ftitle}" placeholder="제목을 입력하세요"></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="board-content" colspan="4">
							<div class="board-content-div">내용 <br/> <br/>
								<textarea rows="12" cols="100" name="fcontent"	required="required" placeholder="내용을 입력하세요">${FDTO.fcontent}</textarea>
							</div>
						</td>
					</tr>
		 			 <tr>
	 			...
	 			<tr>
	 				<th>첨부파일</th>
	 				<td><input type="file" name="files" id="files" value="${FDTO.files}"/></td>
	 				<td>
