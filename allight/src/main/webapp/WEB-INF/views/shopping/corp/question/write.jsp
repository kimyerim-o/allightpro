		...
		<div class="boardContent">
			...
			<table>
				<tr>
					...
					<td class="board-title" colspan="3"><input type="search" name="qtitle" id="title" size="60%" required="required" placeholder="제목을 입력하세요"></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="board-content" colspan="4">
						<div class="board-content-div">내용 <br/><br/>
							<textarea rows="12" cols="100" name="qcontent" id="con" required="required" placeholder="내용을 입력하세요"></textarea></div></td>
				</tr>
			</table>
		</div>
	</div>
