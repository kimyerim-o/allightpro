								...
								<c:if test="${sdto.ino eq oddto.ino}">
									...
									<td class="order_amount"><c:if
											...
											<ul>
												...
												<li class="mb5"><a id="cancel" class="order_btn_write"
													style="cursor: pointer;">주문취소</a></li>
											</ul>
										</c:if> <!-- 배송시작, 배송완료 --> <c:if
											...
											<ul>
												...
												<li class="mb5"><a id="confirm" class="order_btn_write"
													style="cursor: pointer;">구매확정</a></li>
											</ul>
